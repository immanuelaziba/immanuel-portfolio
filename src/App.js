...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      status: "40+ Sales",
      liveUrl: "https://immanuelaziba.github.io/devbrandkits", // Replace with actual URL
      sourceUrl: "https://github.com/immanuelaziba/devbrandkits" // Replace with actual repo
    },
    {
      number: "03",
    ...
    <div className="min-h-screen bg-white text-[#303438] font-light">
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <img src="/immanuelaziba-logo.png" alt="Immanuel Aziba Logo" className="w-8 h-8 object-contain" />
              <div className="text-xl font-light tracking-wide">
                <span className="font-normal">Immanuel Aziba</span></div>
            </div>
      ...
      <section className="min-h-screen flex items-center justify-center relative pt-24 pb-16">
        <div className="max-w-6xl mx-auto px-8 text-center">
          ...
          <div className="mb-16">
            <h1 className="text-8xl md:text-9xl font-extralight mb-8 tracking-tighter leading-none">
              <span className="block text-[#303438]">FROM</span>
              <span className="block text-[#A12121] font-light">CONFUSED</span>
            </h1>
            <div className="flex items-center justify-center my-12">
              <div className="h-px bg-gradient-to-r from-transparent via-[#C6A357] to-transparent w-32"></div>
              <div className="mx-8 text-[#C6A357] text-sm tracking-[0.3em]">TO</div>
              <div className="h-px bg-gradient-to-r from-transparent via-[#C6A357] to-transparent w-32"></div>
            </div>
            <h2 className="text-8xl md:text-9xl font-extralight tracking-tighter leading-none">
          ...
          <div className="flex flex-col items-center gap-8">
            <button
              ...
              className="group relative overflow-hidden bg-[#A12121] text-white px-12 py-4 text-sm tracking-wider transition-all duration-300 hover:bg-[#8B1A1A] hover:-translate-y-0.5"
            >
      ...
      <section className="py-32 border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="text-center mb-20">
            <h2 className="text-6xl font-extralight mb-6 tracking-tight">
              <span className="text-[#303438]">CORE</span>
              <span className="text-[#A12121] ml-4">FOCUS</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-16">
            {skills.map((skill, index) => (
              <div key={index} className="text-center group">
                <h3 className="text-2xl font-light mb-8 text-[#A12121] tracking-wide">
      ...
      {/* Projects Section */}
      <section id="work" className="py-32 bg-gray-50/30">
        <div className="max-w-6xl mx-auto px-8">
          
          <div className="text-center mb-20">
            <h2 className="text-6xl font-extralight mb-6 tracking-tight">
              <span className="text-[#303438]">SELECTED</span>
              <span className="text-[#A12121] ml-4">WORK</span>
            </h2>
            <div className="w-24 h-px bg-[#C6A357] mx-auto"></div>
          </div>
          ...
          <div className="space-y-24">
            {projects.map((project, index) => (
              ...
              >
                <div className="flex items-start justify-between border-b border-gray-200 pb-8 hover:border-[#A12121] transition-all duration-500">
      ...
      <section id="about" className="py-32">
        <div className="max-w-4xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-6xl font-extralight mb-6 tracking-tight text-[#303438]">
              PHILOSOPHY
            </h2>
            <div className="w-24 h-px bg-[#C6A357] mx-auto"></div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="text-center mb-20">
            <h2 className="text-6xl font-extralight mb-6 tracking-tight">
              ...
              <span className="text-[#A12121] ml-4">CONNECT</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            <div className="text-center">
              ...
              <p className="text-base font-light">immanuelaziba@gmail.com</p>
            </div>
            <div className="text-center">
              <div className="mb-4">
              ...
              <p className="text-base font-light">+234.903.152.5643</p>
            </div>
            <div className="text-center">
              <div className="mb-4">
          ...
          <div className="flex items-center justify-center gap-8">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex items-center gap-2 text-[#303438]/60 hover:text-[#A12121] transition-colors duration-300"
            >
